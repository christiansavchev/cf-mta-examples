...
This example shows how to model a simple CF application in an MTA, deploy it, set attributes and configure the deployer behavior
...
NOTE: See link:mta.yaml[mta.yaml] or link:mtad.yaml[mtad.yaml] for details on the attributes, environment and deployer parameters used.
...
## Undeploy the MTA
It is recommended to stop or undeploy running MTAs after they are no longer needed. 
